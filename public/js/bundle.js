...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"signin.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var singUpFn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, role, email, password, passwordConfirm) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function singUpFn(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
var _default = singUpFn;
exports.default = _default;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? "http://127.0.0.1:3000/api/v1/users/updateMe" : "http://127.0.0.1:3000/api/v1/users/passwordUpdate";
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Nbgy6SCjrh5PRdFuykyGD4XXSoylzYRaTlAFzFLsqq7c5neKF408qADKrk6glEg0w3mxIvq3RiFWVFrop8M4Nnf00UcXiZ00E');
...
if (formElementSignin) {
  formElementSignin.addEventListener('submit', function (e) {
    ...
    (0, _signin.default)(name, undefined, email, password, passwordConfirm);
  });
}
var formUserElement = document.querySelector('.form-user-data');
if (formUserElement) {
  formUserElement.addEventListener('submit', /*#__PURE__*/function () {
...
var formUserPassEle = document.querySelector('.form-user-settings');
if (formUserPassEle) {
  formUserPassEle.addEventListener('submit', /*#__PURE__*/function () {
